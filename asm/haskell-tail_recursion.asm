...
.Lc2LV:
	jmp *-16(%r13)
	.size s2Lo_info, .-s2Lo_info
.section .text
.align 8
.align 8
	.long	S2MI_srt-(s2Ls_info)+0
	.long	0
	.quad	0
	.quad	4294967312
s2Ls_info:
...
.Lc2Md:
	jmp *-16(%r13)
	.size s2Ls_info, .-s2Ls_info
.section .text
.align 8
.align 8
	.long	S2MI_srt-(s2Lt_info)+0
	.long	0
	.quad	1
	.quad	4294967313
s2Lt_info:
...
.Lc2Mi:
	jmp *-16(%r13)
	.size s2Lt_info, .-s2Lt_info
.section .text
.align 8
.align 8
	.long	S2MI_srt-(s2Lq_info)+0
	.long	0
	.quad	2
	.quad	4294967315
s2Lq_info:
...
.Lc2Mr:
	jmp *-16(%r13)
	.size s2Lq_info, .-s2Lq_info
.section .text
.align 8
.align 8
	.long	S2MI_srt-(r2L8_info)+0
	.long	0
	.quad	12884901911
	.quad	0
	.quad	30064771087
...
.Lc2Mz:
	...
	ja .Lc2MB
.Lc2MA:
	leaq s2Lo_info(%rip),%rax
	movq %rax,-8(%r12)
	leaq -8(%r12),%rax
	leaq c2LZ_info(%rip),%rbx
	movq %rbx,-32(%rbp)
	movq %r14,%rbx
	movq ghczmprim_GHCziClasses_zdfEqInt_closure@gotpcrel(%rip),%r14
	movq stg_ap_pp_info@gotpcrel(%rip),%rcx
	movq %rcx,-56(%rbp)
	movq %rdi,-48(%rbp)
	movq %rax,-40(%rbp)
...
.Lc2Mu:
	...
	ja .Lc2ME
.Lc2MD:
	leaq s2Lt_info(%rip),%rbx
	movq %rbx,-48(%r12)
	movq %rdx,-32(%r12)
	leaq -48(%r12),%rbx
	leaq s2Lq_info(%rip),%rdx
	movq %rdx,-24(%r12)
	movq %rax,-8(%r12)
	movq %rcx,(%r12)
	leaq -24(%r12),%rax
...
.Lc2MB:
	movq $16,904(%r13)
.Lc2My:
	leaq r2L8_closure(%rip),%rbx
	jmp *-8(%r13)
.Lc2ME:
	movq $56,904(%r13)
	jmp *stg_gc_unpt_r1@gotpcrel(%rip)
	.size r2L8_info, .-r2L8_info
.section .data
.align 8
.align 1
r2L9_closure:
...
.align 8
.align 8
	.long	S2MI_srt-(Main_fibo_info)+8
	.long	0
	.quad	4294967301
	.quad	0
	.quad	4294967311
...
.Lc2Ns:
	movq %r14,%rdi
	leaq r2La_closure+1(%rip),%rsi
	leaq r2L9_closure+1(%rip),%r14
	jmp r2L8_info
...
.align 8
.align 8
	.long	S2MI_srt-(Main_main_info)+24
	.long	0
	.quad	0
	.quad	12884901910
...
.align 8
.align 8
	.long	S2MI_srt-(ZCMain_main_info)+40
	.long	0
	.quad	0
	.quad	12884901910
