...
.Lc3HA:
	...
	ja .Lc3HC
.Lc3HB:
	leaq s3GB_info(%rip),%rax
	movq %rax,-8(%r12)
	leaq -8(%r12),%rax
	leaq c3H0_info(%rip),%rbx
	movq %rbx,-32(%rbp)
	movq %r14,%rbx
...
.Lc3Hv:
	...
	ja .Lc3HF
.Lc3HE:
	leaq s3GG_info(%rip),%rbx
	movq %rbx,-48(%r12)
	movq %rdx,-32(%r12)
	leaq -48(%r12),%rbx
	leaq s3GD_info(%rip),%rdx
	movq %rdx,-24(%r12)
	movq %rax,-8(%r12)
	movq %rcx,(%r12)
	leaq -24(%r12),%rax
...
.Lc3HC:
	movq $16,904(%r13)
.Lc3Hz:
	leaq r3Gl_closure(%rip),%rbx
	jmp *-8(%r13)
.Lc3HF:
	movq $56,904(%r13)
	jmp *stg_gc_unpt_r1@gotpcrel(%rip)
	.size r3Gl_info, .-r3Gl_info
.section .data
.align 8
.align 1
r3Gl_closure:
...
.align 8
	...
	.quad	0
	.long	14
	.long	r3Gl_closure-(Main_fibo_info)+0
...
.Lc3Ir:
	movq %r14,%rdi
	leaq r3Gn_closure+1(%rip),%rsi
	leaq r3Gm_closure+1(%rip),%r14
	jmp r3Gl_info
...
.align 8
	.quad	0
	.long	21
	.long	u3IE_srt-(Main_main_info)+0
...
.align 8
	.quad	0
	.long	21
	.long	u3IV_srt-(ZCMain_main_info)+0
