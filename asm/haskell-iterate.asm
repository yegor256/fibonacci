...
.Lc61K:
	...
	movq %rbx,-16(%rbp)
	movq %rax,-8(%rbp)
	leaq .Lc61M_info(%rip),%rax
	movq %rax,-24(%rbp)
	leaq Main_fibo2_closure+1(%rip),%rsi
	leaq Main_fibo4_closure+1(%rip),%r14
	addq $-24,%rbp
	jmp *base_GHCziList_zdwiterate_info@gotpcrel(%rip)
.Lc61L:
	jmp *(%rbx)
.Lc61Q:
	jmp *-16(%r13)
...
.align 8
	...
	.quad	0
	.long	14
	.long	.Lu62l_srt-(Main_fibo_info)+0
...
.align 8
	.quad	0
	.long	30
	.long	.Lu62l_srt-(.Lc627_info)+0
.Lc627_info:
.Lc627:
	leaq .Lc62d_info(%rip),%rax
	movq %rax,(%rbp)
	movq 7(%rbx),%rsi
	leaq Main_fibo1_closure(%rip),%r14
