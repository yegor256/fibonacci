...
.Lc3EC:
	jmp *-16(%r13)
	.size s3E6_info, .-s3E6_info
.section .text
.align 8
.align 8
	.quad	1
	.long	16
	.long	u3G8_srt-(s3E4_info)+0
s3E4_info:
.Lc3EI:
	leaq -16(%rbp),%rax
	cmpq %r15,%rax
...
.Lc3EJ:
	jmp *-16(%r13)
	.size s3E4_info, .-s3E4_info
.section .text
.align 8
.align 8
	.quad	1
	.long	16
	.long	u3G9_srt-(s3E7_info)+0
s3E7_info:
.Lc3EL:
	leaq -16(%rbp),%rax
	cmpq %r15,%rax
...
.Lc3EO:
	...
	movq %rbx,-8(%rbp)
	movq 16(%rbx),%rax
	leaq s3E6_info(%rip),%rbx
	movq %rbx,-32(%r12)
	leaq -32(%r12),%rbx
	leaq s3E4_info(%rip),%rcx
	movq %rcx,-16(%r12)
	movq %rax,(%r12)
	leaq -16(%r12),%rax
	movq %rbx,%rsi
...
.Lc3EM:
	jmp *-16(%r13)
	.size s3E7_info, .-s3E7_info
.section .text
.align 8
.align 8
	.quad	1
	.long	16
	.long	Main_fibo_closure-(s3E8_info)+0
s3E8_info:
.Lc3EQ:
	leaq -16(%rbp),%rax
	cmpq %r15,%rax
...
.Lc3ER:
	jmp *-16(%r13)
	.size s3E8_info, .-s3E8_info
.section .text
.align 8
.align 8
	.quad	0
	.long	15
	.long	u3G6_srt-(s3E1_info)+0
s3E1_info:
.Lc3F7:
	leaq -16(%rbp),%rax
	cmpq %r15,%rax
...
.Lc3F8:
	jmp *-16(%r13)
	.size s3E1_info, .-s3E1_info
.section .text
.align 8
.align 8
	.quad	1
	.long	16
	.long	u3G8_srt-(s3DZ_info)+0
s3DZ_info:
.Lc3Fe:
	leaq -16(%rbp),%rax
	cmpq %r15,%rax
...
.Lc3Ff:
	jmp *-16(%r13)
	.size s3DZ_info, .-s3DZ_info
.section .text
.align 8
.align 8
	.quad	1
	.long	16
	.long	u3G9_srt-(s3E2_info)+0
s3E2_info:
.Lc3Fh:
	leaq -16(%rbp),%rax
	cmpq %r15,%rax
...
.Lc3Fk:
	...
	movq %rbx,-8(%rbp)
	movq 16(%rbx),%rax
	leaq s3E1_info(%rip),%rbx
	movq %rbx,-32(%r12)
	leaq -32(%r12),%rbx
	leaq s3DZ_info(%rip),%rcx
	movq %rcx,-16(%r12)
	movq %rax,(%r12)
	leaq -16(%r12),%rax
	movq %rbx,%rsi
...
.Lc3Fi:
	jmp *-16(%r13)
	.size s3E2_info, .-s3E2_info
.section .text
.align 8
.align 8
	.quad	1
	.long	16
	.long	Main_fibo_closure-(s3E3_info)+0
s3E3_info:
.Lc3Fm:
	leaq -16(%rbp),%rax
	cmpq %r15,%rax
...
.Lc3Fn:
	jmp *-16(%r13)
	.size s3E3_info, .-s3E3_info
.section .text
.align 8
.align 8
	.quad	1
	.long	16
	.long	Main_fibo_closure-(s3E9_info)+0
s3E9_info:
.Lc3Fr:
	leaq -16(%rbp),%rax
	cmpq %r15,%rax
...
.Lc3Fu:
	...
	movq %rbx,-8(%rbp)
	movq 16(%rbx),%rax
	leaq s3E8_info(%rip),%rbx
	movq %rbx,-40(%r12)
	movq %rax,-24(%r12)
	leaq -40(%r12),%rbx
	leaq s3E3_info(%rip),%rcx
	movq %rcx,-16(%r12)
	movq %rax,(%r12)
	leaq -16(%r12),%rax
	movq %rbx,%rdi
...
.Lc3Fs:
	jmp *-16(%r13)
	.size s3E9_info, .-s3E9_info
.section .text
.align 8
.align 8
	.quad	0
	.long	15
	.long	u3G6_srt-(s3DY_info)+0
s3DY_info:
.Lc3FA:
	leaq -16(%rbp),%rax
	cmpq %r15,%rax
...
.Lc3FB:
	jmp *-16(%r13)
	.size s3DY_info, .-s3DY_info
.section .text
.align 8
.align 8
	.quad	0
	.long	15
	.long	u3G6_srt-(s3DV_info)+0
s3DV_info:
.Lc3FL:
	leaq -16(%rbp),%rax
	cmpq %r15,%rax
...
.Lc3FM:
	jmp *-16(%r13)
	.size s3DV_info, .-s3DV_info
.section .text
.align 8
.align 8
	.quad	1
	.long	16
	.long	u3G5_srt-(s3DT_info)+0
s3DT_info:
.Lc3FS:
	leaq -16(%rbp),%rax
	cmpq %r15,%rax
...
.Lc3FT:
	jmp *-16(%r13)
	.size s3DT_info, .-s3DT_info
.section .text
.align 8
.align 8
	.quad	1
	.long	16
	.long	u3G7_srt-(s3DW_info)+0
s3DW_info:
.Lc3FV:
	leaq -16(%rbp),%rax
	cmpq %r15,%rax
...
.Lc3FY:
	...
	movq %rbx,-8(%rbp)
	movq 16(%rbx),%rax
	leaq s3DV_info(%rip),%rbx
	movq %rbx,-32(%r12)
	leaq -32(%r12),%rbx
	leaq s3DT_info(%rip),%rcx
	movq %rcx,-16(%r12)
	movq %rax,(%r12)
	leaq -16(%r12),%rax
	movq %rbx,%rsi
...
.Lc3G2:
	...
	ja .Lc3G4
.Lc3G3:
	leaq s3E9_info(%rip),%rax
	movq %rax,-56(%r12)
	movq %r14,-40(%r12)
	leaq -56(%r12),%rax
	leaq s3DY_info(%rip),%rbx
	movq %rbx,-32(%r12)
	leaq -32(%r12),%rbx
	leaq s3DW_info(%rip),%rcx
	movq %rcx,-16(%r12)
	movq %r14,(%r12)
	leaq -16(%r12),%rcx
	movq %rax,%rdi
...
.Lc3HA:
	jmp *-16(%r13)
	.size s3Ea_info, .-s3Ea_info
.section .text
.align 8
.align 8
	.quad	0
	.long	21
	.long	u3HI_srt-(s3Eb_info)+0
s3Eb_info:
.Lc3HC:
	leaq -16(%rbp),%rax
	cmpq %r15,%rax
...
.align 8
	.quad	0
	.long	21
	.long	u3I5_srt-(Main_main_info)+0
...
.align 8
	.quad	0
	.long	21
	.long	u3Im_srt-(ZCMain_main_info)+0
