...
.Lc3E8:
	jmp *-16(%r13)
	.size s3DH_info, .-s3DH_info
.section .text
.align 8
.align 8
	.quad	1
	.long	16
	.long	Main_fibo_closure-(s3DI_info)+0
s3DI_info:
.Lc3Ea:
	leaq -16(%rbp),%rax
	cmpq %r15,%rax
...
.Lc3Eb:
	jmp *-16(%r13)
	.size s3DI_info, .-s3DI_info
.section .text
.align 8
.align 8
	.quad	1
	.long	16
	.long	u3EG_srt-(s3DE_info)+0
s3DE_info:
.Lc3En:
	leaq -40(%rbp),%rax
	cmpq %r15,%rax
...
.Lc3Eo:
	jmp *-16(%r13)
	.size s3DE_info, .-s3DE_info
.section .text
.align 8
.align 8
	.quad	1
	.long	16
	.long	Main_fibo_closure-(s3DF_info)+0
s3DF_info:
.Lc3Eq:
	leaq -16(%rbp),%rax
	cmpq %r15,%rax
...
.align 8
	...
	.quad	0
	.long	14
	.long	u3EG_srt-(Main_fibo_info)+0
...
.align 8
	.quad	0
	.long	30
	.long	Main_fibo_closure-(c3DS_info)+0
c3DS_info:
.Lc3DS:
	addq $48,%r12
	cmpq 856(%r13),%r12
...
.Lc3EE:
	...
	jmp *(%rbp)
.Lc3EC:
	leaq s3DI_info(%rip),%rax
	movq %rax,-40(%r12)
	movq %rbx,-24(%r12)
	leaq -40(%r12),%rax
	leaq s3DF_info(%rip),%rcx
	movq %rcx,-16(%r12)
	movq %rbx,(%r12)
	leaq -16(%r12),%rbx
	movq base_GHCziNum_zdfNumInt_closure@gotpcrel(%rip),%r14
...
.align 8
	.quad	0
	.long	21
	.long	u3Fp_srt-(Main_main_info)+0
...
.align 8
	.quad	0
	.long	21
	.long	u3FG_srt-(ZCMain_main_info)+0
