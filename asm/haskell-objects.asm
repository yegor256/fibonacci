...
.Lc2JY:
	...
	movq %rbx,-8(%rbp)
	movq 16(%rbx),%rax
	leaq s2IJ_info(%rip),%rbx
	movq %rbx,-40(%r12)
	movq %rax,-24(%r12)
	leaq -40(%r12),%rbx
	leaq s2IF_info(%rip),%rcx
	movq %rcx,-16(%r12)
	movq %rax,(%r12)
	leaq -16(%r12),%rax
	movq %rbx,%rdi
...
.Lc2Kj:
	jmp *-16(%r13)
	.size s2Iz_info, .-s2Iz_info
.section .text
.align 8
.align 8
	.long	S2Ks_srt-(Main_fibo_info)+0
	.long	0
	.quad	4294967301
	.quad	0
	.quad	1095216660495
...
.Lc2Kp:
	...
	ja .Lc2Kr
.Lc2Kq:
	leaq s2IK_info(%rip),%rax
	movq %rax,-56(%r12)
	movq %r14,-40(%r12)
	leaq -56(%r12),%rax
	leaq s2IB_info(%rip),%rbx
	movq %rbx,-32(%r12)
	leaq -32(%r12),%rbx
	leaq s2Iz_info(%rip),%rcx
	movq %rcx,-16(%r12)
	movq %r14,(%r12)
	leaq -16(%r12),%rcx
	movq %rax,%rdi
...
.Lc2LA:
	jmp *-16(%r13)
	.size s2IL_info, .-s2IL_info
.section .text
.align 8
.align 8
	.long	S2Ks_srt-(s2IM_info)+0
	.long	0
	.quad	0
	.quad	3337189589014
s2IM_info:
...
.align 8
.align 8
	.long	S2Ks_srt-(Main_main_info)+80
	.long	0
	.quad	0
	.quad	12884901910
...
.align 8
.align 8
	.long	S2Ks_srt-(ZCMain_main_info)+96
	.long	0
	.quad	0
	.quad	12884901910
